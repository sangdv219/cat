...
// Folder name	{{dashCase name}}	admin-user/
// Constant name	**{{constantCase name}}**	**ADMIN_USER**
// Interface name	I{{pascalCase name}}	IAdminUser
// Variable name	{{camelCase name}}	adminUser
