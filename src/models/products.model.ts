import {
  ...
  AllowNull,
  Unique,
  ForeignKey, // Cho mối quan hệ
  BelongsTo,
  HasMany, // Cho mối quan hệ
...
// Giả định các mô hình liên quan đã được định nghĩa
// import { CategoryModel } from './CategoryModel';
// import { BrandModel } from './BrandModel';

/**
 * Interface cho các thuộc tính của Product Model
 */
...
export class ProductModel extends BaseModel<ProductAttributes> {
  ...
  @BelongsTo(() => ProductModel, 'parent_id')
  declare parent?: ProductModel;
  
  @HasMany(() => ProductModel, 'parent_id')
  declare variants?: ProductModel[];
}