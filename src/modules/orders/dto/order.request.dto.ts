...
export class CreatedOrderRequestDto implements ICreatedOrderRequest {
  ...
  @ApiProperty({ description: 'discount_amount', example: 100000.0 })
  ...
  @ApiProperty({ description: 'shipping_amount', example: 30000.0 })
  ...
  @ApiProperty({
    ...
    example: 'b672ecdb-d018-49d4-9898-707b990784fd',
  })
  ...
  @ApiProperty({
    description: 'shipping_method_id',
    example: 'a4a5fd8b-d230-4a08-90ec-7acf1d783ca2',
  })
